...
public class Calculations {
    ...
    public Calculations (int annual_income, int num_of_jobs, int duration, int loan){
        ...
        if (ann_inc_prop < 2){
            //Consider number of jobs if credit score is little due to the relative proportion of income to monthly payments
            if (num_of_jobs == 1){
    ...
    public double getOnly_interest(){
        return  ((3.5 + (100 - credit_score) * 0.07));
    }
